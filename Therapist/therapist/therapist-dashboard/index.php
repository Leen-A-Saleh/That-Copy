            ...
            <div class="list">
              ...
              <?php else: ?>
                <?php foreach ($new_requests as $req): ?>
                  <div class="request-item" data-appointment-card data-status="pending">
                    <div class="line-1">
                    ...
                    <div class="actions">
                      <button type="button" class="btn-primary btn-accept" data-appointment-id="<?= (int) $req['appointment_id'] ?>" data-api-url="index.php">قبول</button>
                      <button type="button" class="btn-outline btn-reject" data-appointment-id="<?= (int) $req['appointment_id'] ?>" data-api-url="index.php">رفض</button>
                    </div>
                  </div>
                <?php endforeach; ?>
              <?php endif; ?>
