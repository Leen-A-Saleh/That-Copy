...
require_once __DIR__ . '/../includes/appointment-request-handler.php';

$user_id = $_SESSION['user_id'];
$user_name = $_SESSION['user_name'] ?? '';
$therapist_id = (int) $user_id;

therapist_handle_appointment_request_post($therapist_id);
...
<body>
      ...
      <section class="requests-wrapper dash-card">
        ...
        <div class="requests-list">
          ...
          <?php else: ?>
            ...
            ?>
              <article class="<?= $cardClass ?>" data-appointment-card data-urgent="<?= $isUrgent ? 'true' : 'false' ?>" data-status="pending">
                ...
                <footer class="request-footer">
                  <button type="button" class="btn-primary btn-accept" data-appointment-id="<?= (int) $req['appointment_id'] ?>" data-api-url="index.php">قبول الطلب</button>
                  <button type="button" class="btn-outline btn-reject" data-appointment-id="<?= (int) $req['appointment_id'] ?>" data-api-url="index.php">رفض الطلب</button>
                </footer>
              </article>
            <?php endforeach; ?>
          <?php endif; ?>
  ...
  <script src="../js/appointment-request-actions.js"></script>
