...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($action === 'upload_avatar') {
    ...
    if ($isAjax) {
      ...
      echo json_encode(['success' => $ok, 'path' => $path, 'debug' => $debug]);
      exit;
    }
