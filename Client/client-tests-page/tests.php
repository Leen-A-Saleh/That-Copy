...
<body>
  ...
  <main class="tests-page">
    ...
    <div class="tests-grid">
      <a href="beck.php" class="test-card beck">
      ...
      <a href="hopkins.php" class="test-card hopkins">
        <div class="card-content">
      ...
      <a href="childrenmentalhealth.php" class="test-card portage">
        <div class="card-content">
      ...
      <a href="snap.php" class="test-card snap">
        <div class="card-content">
          <h3>مقياس SNAP</h3>
      ...
      <a href="stress.php" class="test-card stress">
        <div class="card-content">
      ...
      <a href="social-anxiety.php" class="test-card social">
        <div class="card-content">
