...
<html lang="ar">
  ...
  <body>
    ...
    <script>
      ...
      const clapSound = new Audio("./assest/clap.mp3");

      const words = [
        { word: "طائرة", direction: "horizontal" },
        { word: "قطار", direction: "vertical" },
        { word: "سيارة", direction: "horizontal" },
        { word: "مطر", direction: "vertical" },
        { word: "غيم", direction: "horizontal" },
        { word: "نور", direction: "vertical" },
        { word: "ارض", direction: "horizontal" },
        { word: "قوس", direction: "vertical" },
      ];
      const gridSize = 8;
      const arabicLetters = [
        "ا",
