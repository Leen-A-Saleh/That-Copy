...
<html lang="ar" dir="rtl">
  <head>
    <meta charset="UTF-8" />
    <title>Level 1 - ابحث عن الكلمات</title>
  ...
  <body>
    ...
    <script>
      window.CROSSWORD_LEVEL_NUMBER = 1;
    </script>
    ...
    <script>
      ...
      const words = [
        { word: "قمر", direction: "horizontal" },
        { word: "شمس", direction: "vertical" },
        { word: "نجوم", direction: "horizontal" },
      ];
      const gridSize = 6;
      const arabicLetters = [
        "ا",
      ...
      function checkCompletion() {
        if (foundWords.length === words.length) {
          clearInterval(timer);
          correctSound.play();
          crosswordCompleteLevel(1, totalTime, timeLeft).finally(() => {
