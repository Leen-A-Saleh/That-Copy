...
<html lang="ar" dir="rtl">
  <head>
    <meta charset="UTF-8" />
    <title>Level 3 - ابحث عن الكلمات</title>
  ...
  <body>
    ...
    <script>
      window.CROSSWORD_LEVEL_NUMBER = 3;
    </script>
    ...
    <script>
      ...
      const words = [
        { word: "تفاح", direction: "horizontal" },
        { word: "موز", direction: "vertical" },
        { word: "لبن", direction: "horizontal" },
        { word: "باب", direction: "vertical" },
        { word: "سمك", direction: "horizontal" },
        { word: "دب", direction: "vertical" },
      ];
      const gridSize = 6;
      const arabicLetters = [
        "ا",
      ...
      function checkCompletion() {
        if (foundWords.length === words.length) {
          clearInterval(timer);
          correctSound.play();
          crosswordCompleteLevel(3, totalTime, timeLeft).finally(() => {
