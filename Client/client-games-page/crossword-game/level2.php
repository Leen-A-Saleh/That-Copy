...
<html lang="ar" dir="rtl">
  <head>
    <meta charset="UTF-8" />
    <title>Level 2 - ابحث عن الكلمات</title>
  ...
  <body>
    ...
    <script>
      window.CROSSWORD_LEVEL_NUMBER = 2;
    </script>
    ...
    <script>
      ...
      const words = [
        { word: "بيت", direction: "horizontal" },
        { word: "بحر", direction: "vertical" },
        { word: "توت", direction: "horizontal" },
        { word: "عين", direction: "vertical" },
        { word: "لعب", direction: "horizontal" },
      ];
      const gridSize = 6;
      const arabicLetters = [
        "ا",
      ...
      function checkCompletion() {
        if (foundWords.length === words.length) {
          clearInterval(timer);
          correctSound.play();
          crosswordCompleteLevel(2, totalTime, timeLeft).finally(() => {
